"""Fast Channels Dashboard — Streamlit Cloud
Deploy: Push to GitHub → Streamlit Cloud → Share URL
"""
...
st.set_page_config(page_title="Fast Channels Dashboard", page_icon="📊", layout="wide")

# Hide all Streamlit UI for clean full-screen dashboard
st.markdown("""
<style>
#MainMenu,header,footer,.stDeployButton,[data-testid="stToolbar"],
[data-testid="stDecoration"],[data-testid="stStatusWidget"],
section[data-testid="stSidebar"],[data-testid="stSidebarNav"],
.stApp>header,div[data-testid="collapsedControl"]{display:none!important;visibility:hidden!important;height:0!important}
.block-container,div[data-testid="stAppViewBlockContainer"]{padding:0!important;max-width:100%!important;margin:0!important}
...
# Safe column detection for Programme
...
f7.update_layout(paper_bgcolor='rgba(0,0,0,0)',plot_bgcolor='rgba(0,0,0,0)',
    font=dict(family='DM Sans,Segoe UI,sans-serif',color=TX,size=12),margin=dict(l=140,r=20,t=50,b=20),
    title=dict(text='👥 Stacked Breakdown',font=dict(size=14)),barmode='stack',
    xaxis=dict(gridcolor=GR,linecolor=GR,title='Viewership Index',range=[0,400]),yaxis=dict(showgrid=False,linecolor=GR,autorange='reversed',dtick=1),
